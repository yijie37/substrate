...
pub trait StorageValue<T: Codec + EncodeLike> {
...
pub trait StorageMap<K: Encode + EncodeLike, V: Codec + EncodeLike> {
	/// The type that get/take return.
	type Query;
...
pub trait StorageLinkedMap<K: Codec + EncodeLike, V: Codec + EncodeLike> {
	/// The type that get/take return.
	type Query;
...
pub trait StorageDoubleMap<K1: Encode + EncodeLike, K2: Encode + EncodeLike, V: Codec + EncodeLike> {
