...
use crate::codec::{Codec, Encode, Decode, EncodeLike};
...
pub trait Currency<AccountId> {
	...
	type Balance: SimpleArithmetic + Codec + EncodeLike + Copy + MaybeSerializeDebug + Default;
...
pub trait Time {
	type Moment: SimpleArithmetic + Codec + EncodeLike + Clone + Default + Copy;
